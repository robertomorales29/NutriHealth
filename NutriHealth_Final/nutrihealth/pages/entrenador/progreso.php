    ...
    <div class="row g-4">
        <div class="col-lg-4">
            <div class="card card-soft p-4 mb-4">
                ...
                <?php else: ?>
                    <form method="get">
                        <label class="form-label" for="buscar-paciente-progreso-entrenador">Buscar por nombre</label>
                        <input id="buscar-paciente-progreso-entrenador" type="search" class="form-control mb-2" placeholder="Escribe el nombre" data-filter-select="#paciente-progreso-entrenador">
                        <select id="paciente-progreso-entrenador" name="paciente_id" class="form-select mb-3">
            ...
            <div class="card card-soft p-4">
                <h2 class="h5 fw-bold mb-3">Registrar avance físico</h2>
                <form method="post" action="<?= base_url('actions/historial_guardar.php') ?>">
                    <input type="hidden" name="return_to" value="pages/entrenador/progreso.php?paciente_id=<?= (int)$pacienteId ?>">
            ...
            <div class="card card-soft p-4">
                ...
                <?php if ($health || $currentHealth): ?>
                    <div class="alert alert-info">
                        ...
                        <strong>Enfermedades:</strong> <?= e($health['enfermedades'] ?? 'Sin dato') ?>
                    </div>
                <?php endif; ?>
