    ...
    <div class="hero-section shadow-sm p-4 p-lg-5">
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                ...
                <h1 class="display-5 fw-bold mb-3">NutriHealth: tu solución integral para una vida saludable.</h1>
                <p class="lead text-muted mb-4">Conectando pacientes, nutriólogos y entrenadores para mejores resultados en la salud.</p>
                    ...
                    <div class="carousel-inner rounded-5">
                        <div class="carousel-item active">
                            <div class="news-slide d-flex flex-column justify-content-end">
                                ...
                                <h3 class="fw-bold">Nutrición, más que cuidado físico</h3>
                                <p>Las "dietas ya no están de moda", más bien se enfocan en los hábitos alimenticios.</p>
                                <a class="btn btn-light rounded-pill align-self-start" target="_blank" href="https://www.milenio.com/content/salud-y-nutricion/nutricion-desde-la-prevencion-y-no-desde-la-restriccion">Leer noticia</a>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <div class="news-slide slide-two d-flex flex-column justify-content-end">
                                ...
                                <p>Unos pequeños aumentos en la actividad física como parte de nuestra vida cotidiana pueden aportar beneficios a largo plazo para nuestra salud.</p>
                                <a class="btn btn-light rounded-pill align-self-start" target="_blank" href="https://www.bbc.com/mundo/articles/crmpd3l082xo">Leer noticia</a>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <div class="news-slide slide-three d-flex flex-column justify-content-end">
                                ...
                                <p>Tecnología en la salud: su influencia e impacto.</p>
                                <a class="btn btn-light rounded-pill align-self-start" target="_blank" href="https://blog.tecsalud.mx/tecnologia-en-la-salud-su-influencia-e-impacto">Leer noticia</a>
                            </div>
                        </div>
                    </div>
...
<section class="container pb-5">
    <div class="text-center mb-4">
        <h2 class="fw-bold">¿Cómo formarás parte de NutriHealth?</h2>
        <p class="text-muted">Elige tu perfil y comencemos juntos tu camino hacia el bienestar.</p>
    </div>
    <div class="row g-4">
        <div class="col-md-4">
