...
$citas = appointments_for_user((int)$user['id'], 'nutriologo');
$estados = appointment_statuses();
$pageTitle = 'Citas del nutriólogo';
    ...
    <div class="row g-4">
        <div class="col-lg-5">
            <div class="card card-soft p-4">
                <h1 class="h4 fw-bold mb-3">Agendar cita con paciente</h1>
                <form method="post" action="<?= base_url('actions/citas_crear.php') ?>">
                    <input type="hidden" name="return_to" value="pages/nutriologo/citas.php">
